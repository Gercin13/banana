...
import { generate, generateVideo, upscaleImage, upscaleVideo, MODELS, TIERS, VIDEO_MODELS, ASPECT_RATIOS, IMAGE_SIZES, MAX_IMAGES } from "./engine.js";
import {
...
export async function handleGenerate(body = {}, userId = "local") {
  try {
    ...
    // NVIDIA is text-only + single-image (synchronous hosted API, no batching).
