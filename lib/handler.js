...
import { generate, MODELS, ASPECT_RATIOS, MAX_IMAGES } from "./engine.js";
...
export function healthPayload() {
  return { ok: true, tiers: Object.keys(MODELS), aspectRatios: ASPECT_RATIOS, maxImages: MAX_IMAGES };
}
...
export async function handleGenerate(body = {}, userId = "local") {
  try {
    const { prompt, aspectRatio, count, tier } = body;
